              ...
              <ScrollView>
                <View style={{ marginHorizontal: 10, marginTop: 20 }}>
                  ...
                  <Text style={styles.BigregularTxt}>
                    ...
                    provider, società informatiche, agenzie di comunicazione) nominati anche, se necessario, Responsabili del Trattamento da parte del Titolare. L’elenco aggiornato dei Responsabili potrà sempre essere richiesto al Titolare del Trattamento.
                  </Text>
                  ...
                  <Text style={styles.BigregularTxt}>
                    ...
                    cancellazione, rettificazione ed il diritto alla portabilità dei Dati non potranno più essere esercitati.
                  </Text>
                  ...
                  <Text style={styles.BigregularTxt}>
                    <Text style={{ fontWeight: "bold" }}>• revocare il consenso in ogni momento.</Text> L’Utente può revocare il consenso al trattamento dei propri Dati Personali precedentemente espresso.{" "}
                  </Text>
                  <Text style={styles.BigregularTxt}>
                  ...
                  <Text style={styles.BigregularTxt}>
                    <Text style={{ fontWeight: "bold" }}>• verificare e chiedere la rettificazione.</Text> L’Utente può verificare la correttezza dei propri Dati e richiederne l’aggiornamento o la correzione.{" "}
                  </Text>
                  <Text style={styles.BigregularTxt}>
                    <Text style={{ fontWeight: "bold" }}>• ottenere la limitazione del trattamento.</Text> Quando ricorrono determinate condizioni, l’Utente può richiedere la limitazione del trattamento dei propri Dati. In tal caso il Titolare non tratterà i Dati per alcun altro scopo se non la loro conservazione.{" "}
                  </Text>
                  <Text style={styles.BigregularTxt}>
                    <Text style={{ fontWeight: "bold" }}>• ottenere la cancellazione o rimozione dei propri Dati Personali. </Text> Quando ricorrono determinate condizioni, l’Utente può richiedere la cancellazione dei propri Dati da parte del Titolare.{" "}
                  </Text>
                  <Text style={styles.BigregularTxt}>
                    <Text style={{ fontWeight: "bold" }}>• ricevere i propri Dati o farli trasferire ad altro titolare.</Text>. L’Utente ha diritto di ricevere i propri Dati in formato strutturato, di uso comune e leggibile da dispositivo automatico e, ove tecnicamente fattibile, di ottenerne il trasferimento senza ostacoli ad un altro titolare. Questa disposizione è applicabile quando i Dati sono trattati con strumenti automatizzati ed il trattamento è basato sul consenso dell’Utente, su un
                    contratto di cui l’Utente è parte o su misure contrattuali ad esso connesse.
                  </Text>
                  <Text style={styles.BigregularTxt}>
                    <Text style={{ fontWeight: "bold" }}>• proporre reclamo. </Text> . L’Utente può proporre un reclamo all’autorità di controllo della protezione dei dati personali competente o agire in sede giudiziale.
                  </Text>
                  ...
                  <Text style={styles.BigregularTxt}>Questa Applicazione non supporta le richieste “Do Not Track”. Per scoprire se gli eventuali servizi di terze parti utilizzati le supportino, l'Utente è invitato a consultare le rispettive privacy policy.</Text>

                  <Text style={[styles.bigBoldTxt, { marginTop: 10, fontSize: 16 }]}>Modifiche a questa privacy policy</Text>
                  <Text style={styles.BigregularTxt}>
                    Il Titolare del Trattamento si riserva il diritto di apportare modifiche alla presente privacy policy in qualunque momento notificandolo agli Utenti su questa pagina e, se possibile, su questa Applicazione nonché, qualora tecnicamente e legalmente fattibile, inviando una notifica agli Utenti attraverso uno degli estremi di contatto di cui è in possesso. Si prega dunque di consultare con frequenza questa pagina, facendo riferimento alla data di ultima modifica indicata in
                    fondo.
                  </Text>
